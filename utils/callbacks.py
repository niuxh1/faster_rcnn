...
from utils.utils import cvtColor, resize_image, preprocess_input, get_new_img_size
from utils.bbox import decode_box
...
class EvalCallback():
    def __init__(self, net, input_shape, class_names, num_classes, val_lines, log_dir, cuda, \
        ...
        self.bbox_util = decode_box(self.std, self.num_classes)
